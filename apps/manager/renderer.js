...
const _LIVE_LAYOUTS = ['rail', 'sidebar', 'topnav', 'split', 'commander', 'catalog', 'newspaper', 'timeline', 'kanban'];
// Flat layouts render their own shell instead of the gallery/list views.
// ⚠️ Declared here, above applyLayoutMode, because applyLayoutMode('rail') runs
// during init — a const declared further down would still be in its temporal
// dead zone at that point and throw.
const _FLAT_MODES = ['catalog', 'newspaper', 'timeline', 'kanban'];
