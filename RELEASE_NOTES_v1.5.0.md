...
There is now a book button on the gamepage. Press it and Cafe Neurotico shows you what it found:
...
Removing a manual only unlinks it — a file of yours, or one GOG installed, is never deleted. The single exception is a manual Cafe Neurotico downloaded itself, which it does own and does clean up.
